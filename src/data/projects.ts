...
export const openSourceProjects: Project[] = [
  {
    ...
    links: [
      {
        label: 'npm',
        url: 'https://www.npmjs.com/package/@gabrielgustavoandrade/smart-date-input',
      },
      {
        label: 'GitHub',
        url: 'https://github.com/gabrielgustavoandrade/smart-date-input',
      },
    ],
  },

  {
    ...
    subtitle:
      'Chrome extension that removes algorithmic distractions from YouTube',
    summary:
    ...
    links: [
      {
        label: 'GitHub',
        url: 'https://github.com/gabrielgustavoandrade/intentional-youtube',
      },
    ],
  },
];
